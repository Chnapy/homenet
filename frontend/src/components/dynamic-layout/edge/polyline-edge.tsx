...
export const PolylineEdge: React.FC<EdgeProps<PolylineEdgeType>> = ({
    ...
    labelBgBorderRadius, labelBgPadding, labelBgStyle, labelShowBg, labelStyle, interactionWidth
}) => {
    ...
    const getStyles = () => {
        ...
        const { deviceUserMetaMap } = devicesFullQuery.data;
        ...
        const inMeta = deviceUserMetaMap[ inId ];
    ...
    const labels: ElkLabelWithIcon[] = (data?.labels ?? [])
        .map(label => ({
            ...label,
            ...withOffset({
                x: label.x!,
    ...
    return (
        <>
            ...
            <style dangerouslySetInnerHTML={{
                ...
                .react-flow {
                    --xy-edge-label-background-color: transparent; //${themeMap.default.palette.background.default};
                    --xy-edge-label-color: ${themeMap.default.palette.primary.main};
